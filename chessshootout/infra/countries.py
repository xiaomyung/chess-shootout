...
COUNTRIES = tuple(sorted(_RAW, key=lambda entry: fold(entry[1])))

CODES = frozenset(code for code, _ in COUNTRIES)

_NAMES = {code: name for code, name in COUNTRIES}

_CODES_TUPLE = tuple(code for code, _ in COUNTRIES)
