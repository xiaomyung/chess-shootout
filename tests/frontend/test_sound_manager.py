...
ONE_SHOT_DISPATCH = [
    ...
    ("play_combo_streak", "combo_streak"),
...
DISABLED_NOOP_METHODS = [
    ...
    "play_mole_fall", "play_mole_telegraph", "play_mole_pop", "play_mole_heal",
    "play_whack_hit", "play_whack_kill", "play_whack_dry", "play_mole_taunt",
    "play_whiff_ricochet", "play_combo_hit", "play_combo_wrong",
    "play_combo_complete", "play_combo_fail", "play_combo_streak",
